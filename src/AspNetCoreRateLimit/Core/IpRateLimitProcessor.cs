...
namespace AspNetCoreRateLimit
{
    public class IpRateLimitProcessor : RateLimitProcessor
    {
        ...
        public IpRateLimitProcessor(IpRateLimitOptions options,
           ...
           IIpAddressParser ipParser) : base(options, counterStore, policyStore, ipParser)
        {
            //_options = options;
            ...
            //_core = new RateLimitCore(options, _counterStore, ipParser);
        }

        //public override List<RateLimitRule> GetMatchingRules(RequestIdentity identity)
        //{
        ...
        //        //var matchPolicies = filteredPolicies.RuleSet.Where(r => _ipParser.ContainsIp(r.Id, identity.ClientIp)).AsEnumerable();
